...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf(){
        ...
        LibraryUser lUser = new LibraryUser("John", "Smith", "8543210097");

        when(libraryDatabaseMock.listBooksInHandsOf(lUser))
                .thenReturn(resultListOf0Books);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        //When
        List<Book> bookListTest = bookLibrary.listBooksInHandsOf(lUser);
        int bookListSize = bookListTest.size();
        //Then
        assertEquals(1, bookListSize);
    }

    @Test
    public void testListNoBooksBorrowed(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    @Test
    public void testListBooksOneBorrowed(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<>();
        Book book1 = new Book("Harry Potter", "JK Rowlling", 2016);
        resultListOfBooks.add(book1);
        LibraryUser lUser = new LibraryUser("John", "Smith", "8543210097");
    ...
    @Test
    public void testListBooksFiveBorrowed() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
